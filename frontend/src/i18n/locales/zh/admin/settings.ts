export default {
    settings: {
      ...
      defaults: {
        ...
        defaultConcurrency: '默认标准并发数',
        defaultConcurrencyHint: '新用户的最大标准并发请求数',
        defaultExtraConcurrency: '默认额外并发数',
        defaultExtraConcurrencyHint: '新用户默认获得的尽力而为额外并发数，默认值为 0',
      ...
      extraConcurrency: {
        title: '额外并发策略',
        description: '配置默认关闭的尽力而为额外并发策略及各平台预留容量。',
        enabled: '启用额外并发',
        enabledHint: '关闭时，请求继续使用现有标准并发路径。',
        waitTimeout: '额外并发等待超时（秒）',
        reservePercent: '全局预留比例（%）',
        minReservedSlots: '全局最少预留槽位',
        platformOverrides: '平台预留覆盖',
        platformOverridesHint: '覆盖值留空时沿用全局设置。',
        platform: '平台',
        reservePercentOverride: '预留比例覆盖（%）',
        minReservedSlotsOverride: '最少预留槽位覆盖',
        inherit: '沿用全局设置',
        defaultExtraConcurrencyRangeError: '默认额外并发数必须是非负整数。',
        waitTimeoutRangeError: '额外并发等待超时必须是 1 至 300 秒的整数。',
        reservePercentRangeError: '全局预留比例必须在 0 至 100 之间。',
        minReservedSlotsRangeError: '全局最少预留槽位必须是非负整数。',
        platformReservePercentRangeError: '{platform} 的预留比例必须在 0 至 100 之间。',
        platformMinReservedSlotsRangeError: '{platform} 的最少预留槽位必须是非负整数。',
      },
      claudeCode: {

export default {
    settings: {
      ...
      defaults: {
        ...
        defaultConcurrency: 'Default Standard Concurrency',
        defaultConcurrencyHint: 'Maximum standard concurrent requests for new users',
        defaultExtraConcurrency: 'Default Extra Concurrency',
        defaultExtraConcurrencyHint: 'Best-effort extra concurrency assigned to new users; defaults to 0',
      ...
      extraConcurrency: {
        title: 'Extra Concurrency Policy',
        description: 'Configure the default-off best-effort concurrency policy and per-platform reserves.',
        enabled: 'Enable Extra Concurrency',
        enabledHint: 'When disabled, requests continue to use the existing standard concurrency path.',
        waitTimeout: 'Extra Wait Timeout (seconds)',
        reservePercent: 'Global Reserve (%)',
        minReservedSlots: 'Global Minimum Reserved Slots',
        platformOverrides: 'Platform Reserve Overrides',
        platformOverridesHint: 'Leave an override blank to inherit the global value.',
        platform: 'Platform',
        reservePercentOverride: 'Reserve Override (%)',
        minReservedSlotsOverride: 'Minimum Slots Override',
        inherit: 'Inherit global value',
        defaultExtraConcurrencyRangeError: 'Default extra concurrency must be a non-negative integer.',
        waitTimeoutRangeError: 'Extra concurrency wait timeout must be an integer from 1 to 300 seconds.',
        reservePercentRangeError: 'Global reserve percent must be between 0 and 100.',
        minReservedSlotsRangeError: 'Global minimum reserved slots must be a non-negative integer.',
        platformReservePercentRangeError: '{platform} reserve percent must be between 0 and 100.',
        platformMinReservedSlotsRangeError: '{platform} minimum reserved slots must be a non-negative integer.',
      },
      claudeCode: {

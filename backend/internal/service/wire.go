...
func ProvideGatewayAdmission(store GatewayAdmissionStore, gatewayService *GatewayService) *GatewayAdmission {
	return NewGatewayAdmission(store, gatewayService, gatewayService)
}
